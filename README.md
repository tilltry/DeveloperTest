...
Ваш коллега разработал библиотеку классов и консольное приложение по поставленному ему заданию, и руководитель просит вас проверить результат его работы.
...
Код находится в репозитории GitHub. Создайте новую ветку в репозитории и сохраните в ней исправленный вариант.
